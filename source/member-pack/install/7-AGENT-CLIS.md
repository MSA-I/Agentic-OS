...
Down the existing left side of the dashboard you'll see workspaces such as **Claude, OpenClaw, Hermes, Antigravity, and Codex**. Each one reports its own setup state. You don't need all of them — **install only the ones you actually use.**
