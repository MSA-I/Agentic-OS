...
export default function LeadsView() {
  ...
  const handleVoice = useVoiceToInput(setBrief);
      ...
      <Section n={1} icon={<Target size={15} />} title="Define your ideal customer">
        <div className="flex items-end gap-2">
          ...
          <textarea value={brief} onChange={(e) => setBrief(e.target.value)} rows={2}
            ...
            className="flex-1 rounded-lg bg-white/5 border border-white/10 px-3 py-2 text-sm text-white placeholder-white/30 focus:outline-none focus:border-white/25" />
        </div>
