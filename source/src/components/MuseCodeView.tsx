...
export default function MuseCodeView() {
  ...
  return (
    <div className="space-y-4 max-w-[1180px]">
      ...
      <div className="text-[11px] text-[var(--cream-mute)] px-1 flex items-center gap-1.5"><Save size={11} /> Saved to <span className="mono">~/.agentic-os/muse-coder-workspace/</span> — builds as HTML, chats as JSON + readable transcript.</div>
