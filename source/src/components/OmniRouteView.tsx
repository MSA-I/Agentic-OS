      ...
      <div className="relative overflow-hidden rounded-2xl border p-4 sm:p-5" style={{ borderColor: "var(--panel-border)", background: "rgba(255,255,255,0.02)" }}>
        ...
        <div className="relative">
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <div>
              <div className="text-[10px] uppercase tracking-[0.16em] sm:tracking-[0.2em] flex items-center gap-1.5 whitespace-nowrap" style={{ color: ACCENT }}><Sparkles size={11} /> Free Coder · Live Gateway</div>
              <div className="flex items-center gap-3">
                <div className="hidden sm:block text-[19px] font-semibold text-[var(--cream)] leading-tight">Free AI Coder</div>
                <select
                  value={backend}
            ...
            <div className="w-full order-3 sm:order-none sm:w-auto sm:ml-auto flex items-center gap-2 text-[11px] px-3 py-1.5 rounded-full whitespace-nowrap overflow-hidden text-ellipsis" style={{ background: running ? "rgba(45,212,191,0.12)" : "rgba(255,255,255,0.05)", color: running ? ACCENT : "var(--cream-mute)", border: `1px solid ${running ? ACCENT + "55" : "var(--line-soft)"}`, animation: running ? "orGlow 3s ease-in-out infinite" : "none" }}>
