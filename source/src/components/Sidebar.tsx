...
const NAV_VISUALS: Record<string, NavVisual> = {
  ...
  "/glm-code": visual(<SquareTerminal size={18} />, "#10b981", "16,185,129"),
    "/graphify": visual(<Network size={18} />, "#a855f7", "168,85,247"),
...
export default function Sidebar() {
  ...
  return (
    <aside
      ...
      className="hidden md:flex flex-col w-[244px] shrink-0 h-screen overflow-hidden py-6 border-r border-[var(--line-soft)]"
      ...
      >
        <div className="flex items-stretch justify-around px-1 py-1.5">
          {home && (() => {
            ...
            return (
              <Link
                ...
                style={{ color: active ? "var(--fg)" : "var(--fg-dim)", background: active ? style.dim : "transparent" }}
              >
                {style.icon}
          ...
          <button
            ...
            aria-controls="agent-os-mobile-menu"
