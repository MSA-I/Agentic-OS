    ...
    >
      {tab === "graph" ? (
        <div className="flex flex-col h-full min-h-0">
          ...
          <div className="flex gap-1.5 mb-3 scroll-rail pb-1 -mx-1 px-1">
            {tabs.map((t) => (
              <button
                key={t.key}
            ...
            <button
              ...
              className="lg:ml-auto px-2.5 py-1 rounded-md text-[11px] flex items-center gap-1.5 border transition bg-[rgba(168,85,247,0.12)] border-[rgba(168,85,247,0.4)] text-[var(--fg)] hover:border-[rgba(168,85,247,0.7)]"
