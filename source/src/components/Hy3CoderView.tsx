...
export default function Hy3CoderView() {
  ...
  return (
    <div className="space-y-4 max-w-[1180px]">
      ...
      <div className="relative overflow-hidden rounded-2xl border p-4 sm:p-5" style={{ borderColor: "var(--panel-border)", background: "rgba(255,255,255,0.02)" }}>
        ...
        <div className="relative">
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <div>
              <div className="text-[10px] uppercase tracking-[0.16em] sm:tracking-[0.2em] flex items-center gap-1.5 whitespace-nowrap" style={{ color: ACCENT }}><Sparkles size={11} /> Open-Weights Coder · Live</div>
              <div className="hidden sm:block text-[19px] font-semibold text-[var(--cream)] leading-tight">Hy3 Coder</div>
            </div>
          ...
          <p className="text-[13px] text-[var(--cream-soft)] mt-3 leading-relaxed max-w-[660px]">
            Tencent&apos;s <b className="text-[var(--cream)]">Hunyuan 3</b> (Apache-2.0, 262K context) — a cheap, strong open-weights coder. Type a prompt, watch it build <b className="text-[var(--cream)]">live as it goes</b>. Builds and chat history both survive a refresh.
          </p>
      ...
      <div className="text-[11px] text-[var(--cream-mute)] px-1 flex items-center gap-1.5"><Save size={11} /> Saved to <span className="mono">AGENT-OS-FOLDERS/hy3-coder-workspace/</span> — builds as HTML, chats as JSON + readable transcript.</div>
