...
const meta: Record<WorkspaceAgent, {
  ...
  codex: {
    accent: "#4ade80", shell: "#090d0b", product: "CODEX",
  ...
  claude: {
    accent: "#d97757", shell: "#15110f", product: "CLAUDE CODE",
  ...
  hermes: {
    accent: "#60a5fa", shell: "#08111e", product: "HERMES",
  ...
  openclaw: {
    accent: "#f472b6", shell: "#120b12", product: "OPENCLAW GATEWAY",
  ...
  antigravity: {
    accent: "#8b5cf6", shell: "#0d0917", product: "ANTIGRAVITY",
...
export default function AgentWorkspaceShell({
  ...
  return (
    <div className={`grid min-h-[calc(100vh-190px)] grid-cols-1 gap-4 ${gridClass}`}>
