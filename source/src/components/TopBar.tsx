...
const TITLES: Record<string, PageMeta> = {
  ...
  "/omniroute":   { numeral: "VIII.", label: "Agent · Free AI Coder", title: "Free AI Coder", sub: "Two local routers, one dropdown: OmniRoute (free pool, zero keys) and 9Router (573 models via the logins you already own — Claude Code, Codex, Copilot). Auto-fallback, token compression, everything on your Mac. Code for free, no lock-in." },
