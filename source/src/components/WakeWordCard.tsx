  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: "none",
        transition: "border-color var(--motion-default, 160ms) ease-out",
      }}
    >
      <div className="flex items-center gap-5">
        <button
          ...
          style={{
            ...
            background: live ? "var(--gold, #edff45)" : "var(--bg-card)",
            boxShadow: "none",
            transition: "background-color var(--motion-default, 160ms) ease-out",
          }}
        >
          {phase === "working" || busy
            ? <Loader2 size={24} className="animate-spin" color="var(--deep-outer-space, #101630)" />
            : live
              ? <Ear size={24} color="var(--deep-outer-space, #101630)" strokeWidth={2.4} />
        ...
        <div data-hermes-wake-copy className="min-w-0 flex-1">
          <div className="flex items-baseline justify-between gap-3 flex-wrap">
            ...
            <span className="flex items-center gap-1.5 text-[11px] font-semibold tracking-[0.14em]"
                  style={{ color: live ? teal : "var(--fg-dim)" }}>
              {phase === "listening" && (
          ...
          <div className="text-[12.5px] mt-1" style={{ color: "var(--fg-dim)" }}>
            {phase === "mic-blocked"
          ...
          <div className="text-[10.5px] mt-1.5" style={{ color: "var(--fg-mute)", letterSpacing: "0.04em" }}>
