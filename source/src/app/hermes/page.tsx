...
import { Cpu, MessageSquare, Terminal, Layers, Target, Plug, Sparkles, History, LayoutDashboard, Mic, Radar, Mail, Boxes, Flame} from "lucide-react";
...
export default function HermesRoute() {
  ...
  return (
    <AgentWorkspaceShell agent="hermes" active={section}><div className="space-y-5">
