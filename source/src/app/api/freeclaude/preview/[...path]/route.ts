...
// Path-based preview for Free Claude Code scratch projects.
// URL: /api/freeclaude/preview/<project>/<...rel>
//
// Browser-resolves relative asset paths inside HTML pages (a /landing.html
// linking <link href="style.css">, an <img src="hero.png">, a <video src="render.mp4">
// from HyperFrames, etc.) because the URL structure mirrors a real file tree.
