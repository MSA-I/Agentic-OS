...
import { KIMI_SCRATCH_ROOT } from "@/lib/kimiWorkspace";
import { isSafeProjectName } from "@/lib/projectName";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

// Path-based preview for Kimi scratch projects — twin of /api/antigravity/preview.
// URL: /api/kimi/preview/<project>/<...rel>
// Browser-resolves relative asset paths (HTML referencing src/style.css, img tags
// pointing at public/hero.png, etc.) because the URL structure matches a real
// file tree.
