...
import { resolveBucketFile } from "@/lib/hermesWorkspace";
import { isSafeProjectName } from "@/lib/projectName";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

// Path-based preview for Hermes buckets — twin of the other agents'.
// URL: /api/hermes/preview/<bucket>/<...rel>
//
// The first segment is the bucket id ("images", "audio", "pastes", "workspace",
// "sandboxes"); remaining segments are the bucket-relative file path. The lib
// layer (resolveBucketFile) handles the security guard — only paths that resolve
// inside one of the bucket's configured roots are served.
