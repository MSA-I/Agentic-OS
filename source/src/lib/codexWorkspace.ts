...
// `codex exec resume` does not accept the top-level `--sandbox <mode>` flag
// (codex-cli 0.144 exits 2 with "unexpected argument '--sandbox'"). It does
// accept config overrides, so preserve the exact same policies through
