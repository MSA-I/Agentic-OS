...
>
> 📦 **This pack: version `2026-08-10` (built 10 August 2026).** To check you're on the latest, compare this against the newest pack in the AI Profit Boardroom — or just run `Update Agent OS.command`.
>
