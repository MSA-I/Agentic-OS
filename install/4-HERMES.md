...
## What you get
The full **Hermes** tab: Chat, Hermes-Jarvis (the voice), Hermes Muse, Studio, Sessions, Workspace, MCPs, Manage, Control Room, and Goal Mode. You can say "research X and write me a summary" and it actually does it.
